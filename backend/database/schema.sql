-- Stock Management System - MySQL Schema (reference dump)
-- Prefer: composer migrate && composer db:seed
-- Charset: utf8mb4
...
INSERT INTO `settings` (`id`, `company_name`, `logo_url`) VALUES (1, 'My Company', NULL);
